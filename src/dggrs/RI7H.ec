...
private:
   ...
   int64 triNumber(int64 n)
   {
      if (n <= 0) return 0;
      return n * (n + 1) / 2;
   }

   int64 sumArithmeticSeries(int64 n, int64 firstTerm, int64 commonDiff)
   {
       if (n <= 0) return 0;
   ...
   int64 computeAddedContrib(uint64 nScanlines, int zonesAdded, uint nTimesAdditionRepeated,
   ...
   int64 computeHexOddDepthSubZones(int rDepth)
   {
