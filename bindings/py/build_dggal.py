...
ecrt_location = os.path.join(pkg_resources.get_distribution("ecrt").location, 'ecrt')
...
ffi_ecrt.set_source('_pyecrt',
               ...
               include_dirs=[path.join(ecdev_location, 'include')],
               libraries=[],
...
ffi_dggal.set_source('_pydggal',
               ...
               libraries=libs,
               extra_link_args=extra_link_args,
               library_dirs=[libdir, path.join(ecrt_location, 'lib')],
               py_limited_api=False)
